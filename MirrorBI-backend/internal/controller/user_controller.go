...
// @Success      200  {object}  common.Response{data=userVO.UserLoginVO} "登录成功，返回用户视图"
...
// @Tags         user
// @Produce      json
// @Success      200  {object}  common.Response{data=userVO.UserLoginVO} "获取用户视图成功"
// @Failure      400  {object}  common.Response "获取失败，详情见响应中的code"
// @Router       /api/user/get/login [GET]
func GetLoginUser(c *gin.Context) {
	...
	//返回用户视图
	common.Success(c, *userVO.GetUserLoginVO(*user))
}
...
// @Produce      json
// @Param		id query string true "用户的ID"
// @Success      200  {object}  common.Response{data=userVO.UserVO} "查询成功，返回用户的脱敏信息"
// @Failure      400  {object}  common.Response "查询失败，详情见响应中的code"
// @Router       /api/user/get/vo [GET]
...
// @Failure      400  {object}  common.Response "更新失败，详情见响应中的code"
// @Router       /api/user/list/page/vo [POST]
